...
public class SearchResult extends JFrame implements ActionListener,KeyListener{
    ...
    JLabel jlsubTitle,jlsubUseTip,jlsubInfoID,jlsubInfoName,jlsubInfoReg,jlsubInfoSubject,jlsubInfoIDvalue,jlsubInfoNamevalue,jlsubInfoRegvalue,jlsubInfoSubjectva;
    ...
    public SearchResult(String ID,int st) throws IOException{
        ...
        jlsubInfoSubject = new JLabel("| 专业：");
        ...
        jlsubInfoSubjectva = new JLabel(ExcelController.getSubject(ID, stage));
        ...
        jpsubInfo.add(jlsubInfoSubject);
        jpsubInfo.add(jlsubInfoSubjectva);
