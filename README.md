...
4. 两表合并功能请注意查看合并页面上的注意事项，要记录重复领取的表格请放到sheet1 ，另一个表格放sheet2，合并后所有sheet1和sheet2的记录会写在sheet1里，两表同时有yes记录的人的最后一列“重复领取”会写上“是”。当第二次使用合并功能前，请手动清空“重复领取”这一列。两张excel表格的id号顺序和数量要一致，否则会记错 

   ![ExcelSystem1](ExcelSystem1.png)

   ![ExcelSystem2](ExcelSystem2.png)

   ![ExcelSystem3](ExcelSystem3.png)
